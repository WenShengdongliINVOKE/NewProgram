...
namespace 小玩意
{
    ...
    { /// <summary>
      ...
      /// </summary>
        ...
        List<Controller>? listcontroller = new List<Controller>();
        ...
        public Tuple<List<AbbRobotCommunication>, ControllerInfo[]> GetABBRobot()
        {
            ...
            //用于接收所返回的机器人信息类
            AbbRobotCommunication abbRobotCommunication = new();
            ...
            {   //扫描环境内的机器人
                ...
                {
                    abbRobotCommunication.SystemVersion = controller.Version.ToString();
                    abbRobotCommunication.SystemVersion = controller.Version.ToString();
                    abbRobotCommunication.SystemName = controller.SystemName;
                    abbRobotCommunication.IpAddress = controller.IPAddress.ToString();
                    abbRobotCommunication.Id = +1;
                    abbRobotCommunications.Add(abbRobotCommunication);
            ...
            if (controller.IsMaster == false && controller.OperatingMode == ControllerOperatingMode.Auto)
            {
                try
                {
                    using (var m = Mastership.Request(controller))
                    {
                        ...
                        abbRobotCommunication.X = rb.Trans.X;
                        abbRobotCommunication.Y = rb.Trans.Y;
                        abbRobotCommunication.Z = rb.Trans.Z;
                    }
                }
                catch (Exception ex)
                {
        ...
        /// 获取工具坐标系
        /// </summary>
        public void GetRobotToolRealTimeGestures()
        {
            RobTarget robTarget = controller.MotionSystem.ActiveMechanicalUnit.GetPosition(CoordinateSystemType.World);
            this.X = robTarget.Trans.X;
            this.Y = robTarget.Trans.Y;
